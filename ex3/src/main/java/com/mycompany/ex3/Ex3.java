...
public class Ex3 {
    ...
    public static void main(String[] args) {
       GerenciadorAnimal gerenciadorAnimal = new GerenciadorAnimal();
        ...
        // Adicionando animais
        gerenciadorAnimal.adicionarAnimal(new Animal(201, "Cachorro", "Golden Retriever", 3, 30));
        gerenciadorAnimal.adicionarAnimal(new Animal(202, "Gato", "Siames", 2, 4));
        gerenciadorAnimal.adicionarAnimal(new Animal(203, "Papagaio", "Ararauna", 5, 1));
        gerenciadorAnimal.adicionarAnimal(new Animal(204, "Cavalo", "Puro-sangue inglês", 6, 500));
